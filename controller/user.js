      ...
      return new Promise((resolve,reject)=>{
          async.waterfall([
              ...
              function (token, user, done) {
                ...
                let html = `You are receiving this because you (or someone else) have requested the reset of the password for your account.<br><br>Please click on the following link:<br><br><a clicktracking=off href="${process.env.DASHBOARD_URL}/forgot-password-set?t=${token}">click here</a><br><br><span style="opacity:0.4">Do nothing and your password will remain unchanged.</span><br><br><span style="opacity:0.4">If you DID NOT request this, there may be an attacker trying to gain access. Change your password immediately and reply to this message to let us know.</span>`
